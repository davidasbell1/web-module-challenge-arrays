...
function addFlavor(flavorlist,flavor){
...
function removeLastFlavor(flavorlist,flavor){

    flavorlist.pop(flavor)
return console.log(flavorlist)
}
...
function getFlavorByIndex(flavorlist,flavor){

    flavorlist.indexOf(flavor)
return console.log(flavorlist[flavor])
}
